 ...
 * 主播与主播连麦
 */
public class PushStreamLinkerActivity extends AppCompatActivity implements RecordMonitor {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_stream_to_stream, menu);
        return true;
    }
                ...
                yfEncoderKit.captureCurrentFrame(System.currentTimeMillis() + "", new YfEncoderKit.OnPictureSaveListener() {
                    ...
                    public void onSaved(final String result) {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(PushStreamLinkerActivity.this, "截图成功:" + result, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
...
//                    audioManager.setMode(AudioManager.MODE_IN_COMMUNICATION);
    ...
    protected void showToast(final String text) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(PushStreamLinkerActivity.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
